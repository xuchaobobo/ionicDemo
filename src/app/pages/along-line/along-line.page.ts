...
export class AlongLinePage implements OnInit {
  ...
  constructor(
    ...
    this.dayTime = moment(new Date(Date.now()-1000*60*60*24*720)).format(this.forYear);
  ...
  dateTypeChange(){
    ...
    if (this.dateType == 'year') {
			this.dayTime=moment(new Date(Date.now() - 24 * 365*10 * 60 * 60 * 1000)).format(this.forYear)
  ...
  searchData(){
    ...
    //   water=1.697
    // }
    var datastr='AV'+(this.types.toUpperCase())
