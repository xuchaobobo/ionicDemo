...
export class RiverInfoPage extends Baseui implements OnInit {
  ...
  stationWater:any;
  stationWaterName:any='向家坝水库'
  startTime: any;
  endTime: any;
  selectTab: any = 'tab1'
  constructor(public httpService: ProviderService,public toastController: ToastController) {
    super()
  ...
  staionChange(event: {
    ...
    this.stationWaterName=event.value
